...
namespace KaleidoVR.EditorTools
{
    ...
    public class KaleidoOptimizerProfile
    {
        ...
        public bool avatarDisableReceiveShadows = false;
    ...
    {
        public static readonly string VERSION = "1.0.70";
        ...
        private KaleidoOptimizerProfile CaptureSettings()
        {
            return new KaleidoOptimizerProfile
            {
                ...
                avatarDisableReceiveShadows = avatarDisableReceiveShadows,
        ...
        public void LoadProfile(KaleidoOptimizerProfile p, bool respectIncludes)
        {
            ...
            if (avatar)
            {
                ...
                avatarDisableReceiveShadows = p.avatarDisableReceiveShadows;
        ...
        private void LoadEditorPreferences()
        {
            ...
            avatarDisableReceiveShadows = GetBool("AvRecv", false);
        ...
        private void ApplyAvatarTabDefaults(int presetIndex)
        {
            ...
            avatarDisableReceiveShadows = false;
        ...
        public void SaveEditorPreferences()
        {
            ...
            SetBool("AvRecv", avatarDisableReceiveShadows);
    ...
    public static class KaleidoVRCOptimizerUI
    {
        ...
        private static void DrawAvatarTab(KaleidoVRCOptimizer window)
        {
            ...
            window.avatarDisableReceiveShadows = DrawToggle(window.avatarDisableReceiveShadows, "Disable receive shadows", "Off by default. Turns receive shadows off on renderers on the upload copy. Scene (PC) can write the same flag on the project.");
        ...
        private static void DrawSceneTab(KaleidoVRCOptimizer window)
        {
            ...
            window.rendererDisableReceiveShadows = DrawToggle(window, KaleidoOptionUndo.DisableReceiveShadows, window.rendererDisableReceiveShadows, "Disable receive shadows", "Avatars often skip receiving world shadows. Uncheck if you want contact shadows on the body. On Upload can turn this off on the upload copy. Apply here writes the project.");
